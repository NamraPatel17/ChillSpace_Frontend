  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-8 sm:p-12 border border-gray-100 text-center">
        ...
        <p className="text-gray-600 text-lg">Discover how easy it is to book your dream getaway or start earning as a host on ChillSpace.</p>
        <div className="mt-8 p-4 bg-blue-50 text-blue-800 rounded-lg">
          <p>This page is currently under construction. Check back soon for detailed guides!</p>
        </div>
      </div>
    </div>
  );
